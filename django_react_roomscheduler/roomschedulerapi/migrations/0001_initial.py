# Generated by Django 5.0.1 on 2024-04-30 18:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('floor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='roomschedulerapi.floor')),
                ('optimization_score', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='roomschedulerapi.optiscore')),
